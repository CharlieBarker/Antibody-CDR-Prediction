...
my $datafile = "CLUSTERTHIS.dat";           #  use:  K = 2,  mask = "N111",  vmask = "N111"
...
my $mask = "N1";         # for mydatafile1.dat, mydatafile2.dat, and sphericaldata.csv 
...
my $vmask = "N1";                 # for mydatafile1.dat and mydatafile2.dat
